...
sim_basket <- sample(shot_outcomes, size = 1, replace = TRUE,prob =c(0.45,(1-0.45)))
```
...
# type your code for the Exercise here, and Knit
length<-calc_streak(sample(shot_outcomes, size = 133, replace = TRUE,prob =c(0.45,(1-0.45))))
sim_streak<-data.frame(length)
```
